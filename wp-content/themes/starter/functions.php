...
function ilawyer_content_image_sizes_attr( $sizes, $size ) {
	$width = $size[0];
​
...
add_filter( 'wp_calculate_image_sizes', 'ilawyer_content_image_sizes_attr', 10 , 2 );
​
// Responsive Featured Images 
function ilawyer_post_thumbnail_sizes_attr( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'ilawyer_post_thumbnail_sizes_attr', 10 , 3 );
